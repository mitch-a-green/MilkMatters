...
import com.milkmatters.honoursproject.milkmatters.views.FeedImageView;
...
public class FeedListAdapter extends BaseAdapter {
    ...
    public FeedListAdapter(Activity activity, List<EducationFeedItem> feedItems) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        EducationFeedItem item = feedItems.get(position);
        ...
        CharSequence timeAgo = item.getTimeStamp();
        Log.d("time", ""+timeAgo);
